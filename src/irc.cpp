...
// Copyright (c) 2011-2012 ArkVentureCoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("ArkVentureCoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #ArkVentureCoinTEST0\r");
            Send(hSocket, "WHO #ArkVentureCoinTEST0\r");
        } else {
            // randomly join #ArkVentureCoin00-#ArkVentureCoin99
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #ArkVentureCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #ArkVentureCoin%02d\r", channel_number).c_str());
        }
